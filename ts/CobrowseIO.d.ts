...
export default class CobrowseIO {
    ...
    static set api(api: string): void

    static set license(license: string): void

    static set customData(customData: Record<string, any>): void

    static set deviceToken(token: string): void
