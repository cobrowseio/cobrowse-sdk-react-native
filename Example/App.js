...
import { CobrowseView, Redacted, SessionControl, Unredacted, unredact } from 'cobrowse-sdk-react-native'
        ...
        <View style={styles.container}>
          ...
          { this.state.show % 3 ? <View style={styles.container}>
            ...
            <Redacted style={styles.container}>
              <View><Text>No redaction</Text></View>
              <Unredacted><Text>Unredacted</Text></Unredacted>
              <Redacted><Text>No redaction</Text></Redacted>
              <Redacted>
                <View><Text>Nested no redaction</Text></View>
                <Unredacted><Text>Nested unredacted</Text></Unredacted>
                <Redacted><Text>Nested redaction</Text></Redacted>
              </Redacted>
            </Redacted>
            <Redacted>
              <Unredacted>
                <Text>Unredacted 1</Text>
                <Unredacted><Text>Unredacted 2</Text></Unredacted>
              </Unredacted>
